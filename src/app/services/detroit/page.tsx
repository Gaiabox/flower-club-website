...
export const metadata: Metadata = {
  title: "AI Automation & Branding Agency Detroit MI | The Flower Club",
  description:
    "Detroit's culture-forward creative agency. Brand identity, web design, AI-powered digital employees, and content for businesses ready to stand out. Plus paid AI audits from $2,500 that find where local businesses bleed money.",
};
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-[#FAF7F2]">
      <section className="pt-36 pb-20 px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        ...
        <h1 className="text-5xl md:text-7xl font-bold leading-[1.05] mb-8 max-w-3xl">
          Detroit&apos;s Brand Agency.
        </h1>
        <p className="text-[#FAF7F2]/60 text-xl leading-relaxed max-w-2xl mb-10">
          Detroit is reinventing itself, new industries, new energy, new ambition. But too many
          businesses here are still running on outdated brands and broken digital foundations. The
          Flower Club is a{" "}
          <strong className="text-[#FAF7F2]/90">branding agency in Detroit MI</strong> built for
          businesses that are ready to match their ambition with how they show up.
        </p>
        <Link
          href="/contact"
      ...
      <CityAudit city="Detroit" industries="manufacturers, practices, and service businesses" />
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        ...
        <p className="text-[#FAF7F2]/60 text-lg max-w-2xl mb-10 leading-relaxed">
          ...
          <strong className="text-[#FAF7F2]/90">Detroit businesses</strong> ready to compete.
        </p>
