    ...
    <main className="min-h-screen bg-[#0a0a0a] text-[#FAF7F2]">
      <section className="pt-36 pb-20 px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        ...
        <h1 className="text-5xl md:text-7xl font-bold leading-[1.05] mb-8 max-w-3xl">
          Atlanta&apos;s Brand Agency.
        </h1>
        <p className="text-[#FAF7F2]/60 text-xl leading-relaxed max-w-2xl mb-10">
          Atlanta is the cultural capital of the South — music, film, tech, and a business scene
          that sets the tone for the rest of the country. Brands here need to move with the culture,
          not behind it. The Flower Club is a{" "}
          <strong className="text-[#FAF7F2]/90">branding agency in Atlanta GA</strong> that builds
          brands as forward as the city they represent.
        </p>
        <Link
          href="/contact"
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        ...
        <p className="text-[#FAF7F2]/60 text-lg max-w-2xl mb-10 leading-relaxed">
          ...
          <strong className="text-[#FAF7F2]/90">Atlanta businesses</strong> ready to compete.
        </p>
