...
export const metadata: Metadata = {
  title: "AI Automation & Branding Agency Los Angeles CA | The Flower Club",
  description:
    "Los Angeles' culture-forward creative agency. Brand identity, web design, AI-powered digital employees, and content for businesses ready to stand out. Plus paid AI audits from $2,500 that find where local businesses bleed money.",
};
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-[#FAF7F2]">
      <section className="pt-36 pb-20 px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        ...
        <h1 className="text-5xl md:text-7xl font-bold leading-[1.05] mb-8 max-w-3xl">
          Los Angeles&apos; Brand Agency.
        </h1>
        <p className="text-[#FAF7F2]/60 text-xl leading-relaxed max-w-2xl mb-10">
          LA is image-first, everyone is branding something, and most of it looks the same.
          Standing out in a visual-first market takes more than aesthetics; it takes strategy. The
          Flower Club is a{" "}
          <strong className="text-[#FAF7F2]/90">branding agency in Los Angeles CA</strong> that
          builds brands with real substance behind the style.
        </p>
        <Link
          href="/contact"
      ...
      <CityAudit city="Los Angeles" industries="med spas, entertainment companies, and practices" />
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        ...
        <p className="text-[#FAF7F2]/60 text-lg max-w-2xl mb-10 leading-relaxed">
          ...
          <strong className="text-[#FAF7F2]/90">Los Angeles businesses</strong> ready to compete.
        </p>
      ...
      <section className="py-24 px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        <div className="bg-[#1B2A4A] p-12 md:p-16 text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-[#FAF7F2] mb-4">
            Ready to stand out in Los Angeles?
          </h2>
