    ...
    <main className="min-h-screen bg-[#0a0a0a] text-[#FAF7F2]">
      <section className="pt-36 pb-20 px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        ...
        <p className="text-[#FAF7F2]/60 text-xl leading-relaxed max-w-2xl mb-10">
          Dallas is booming, new money, new businesses, new industries moving in every month. The
          city is growing faster than most brands can keep up. The Flower Club is a{" "}
          <strong className="text-[#FAF7F2]/90">branding agency in Dallas TX</strong> that builds
          brands ready for where the city is going, not where it&apos;s been.
        </p>
        <Link
          href="/contact"
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        ...
        <p className="text-[#FAF7F2]/60 text-lg max-w-2xl mb-10 leading-relaxed">
          ...
          <strong className="text-[#FAF7F2]/90">Dallas businesses</strong> ready to compete.
        </p>
