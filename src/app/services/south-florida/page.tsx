    ...
    <main className="min-h-screen bg-[#0a0a0a] text-[#FAF7F2]">
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        ...
        <p className="text-[#FAF7F2]/60 text-lg max-w-2xl mb-10 leading-relaxed">
          We&apos;ve worked with Fortune 500 brands at Art Basel, cultural events, and premium
          activations across South Florida. That same level of craft is available to{" "}
          <strong className="text-[#FAF7F2]/90">South Florida businesses</strong> ready to
          level up.
        </p>
