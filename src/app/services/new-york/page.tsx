...
export const metadata: Metadata = {
  title: "AI Automation & Branding Agency New York NY | The Flower Club",
  description:
    "New York's culture-forward creative agency. Brand identity, web design, AI-powered digital employees, and content for businesses ready to stand out. Plus paid AI audits from $2,500 that find where local businesses bleed money.",
};
...
export default function NewYorkPage() {
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-[#FAF7F2]">
      ...
      <CityAudit city="New York" industries="law firms, practices, and growing brands" />
