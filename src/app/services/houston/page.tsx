...
export const metadata: Metadata = {
  title: "AI Automation & Branding Agency Houston TX | The Flower Club",
  description:
    "Houston's culture-forward creative agency. Brand identity, web design, AI-powered digital employees, and content for businesses ready to stand out. Plus paid AI audits from $2,500 that find where local businesses bleed money.",
};
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-[#FAF7F2]">
      <section className="pt-36 pb-20 px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        ...
        <h1 className="text-5xl md:text-7xl font-bold leading-[1.05] mb-8 max-w-3xl">
          Houston&apos;s Brand Agency.
        </h1>
        <p className="text-[#FAF7F2]/60 text-xl leading-relaxed max-w-2xl mb-10">
          Houston is massive, diverse, and home to the fastest-growing industries in the country -
          energy, medical, tech. But too many businesses here have brands that don&apos;t match the
          scale. The Flower Club is a{" "}
          <strong className="text-[#FAF7F2]/90">branding agency in Houston TX</strong> that builds
          brands big enough for a city that never stops expanding.
        </p>
        <Link
          href="/contact"
      ...
      <CityAudit city="Houston" industries="manufacturers, law firms, and med spas" />
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        ...
        <p className="text-[#FAF7F2]/60 text-lg max-w-2xl mb-10 leading-relaxed">
          ...
          <strong className="text-[#FAF7F2]/90">Houston businesses</strong> ready to compete.
        </p>
